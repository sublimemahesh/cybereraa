$(function () {
    ...
    let table = $('#team-rankers').DataTable({
        scrollX: true,
        destroy: true,
        processing: true,
        serverSide: true,
        ...
        columns: [
            ...
            {data: "activated", searchable: false, name: 'activated_at', orderable: false},
            {data: "created", searchable: false, name: 'created_at', orderable: false},
        ],
        columnDefs: [
            {
