            ...
            ezoom = {
                ...
                setTransformOrigin: function(s, r, x, y) {
                    ...
                    var trans = 'scale(' + ezoom.scale + ') translateX(' + ezoom.translateX + 'px) translateY(' + ezoom
                        .translateY + 'px) rotate(' + ezoom.rotate + 'deg)';
                    // console.log(trans);
                    ezoom.imgTag.css({
                ...
                initEvent: function() {
                    ...
                    ezoom.zoomModal.on('mousedown', function(e) {
                        ...
                        if (typeof ezoom.options.onMoveStarted && typeof ezoom.options.onMoveStarted ==
                            "function") {
                    ...
                    $(document).on('mouseup', function() {
                        ...
                        translateX_ = ezoom.translateX;
                        translateY_ = ezoom.translateY;
                        if (ezoom.options.onMovedCompleted && typeof ezoom.options.onMovedCompleted ==
                            "function") {
                    ...
                    $(document).on('keydown', function(e) {
                        ...
                        if (e.keyCode && ezoom.isShow) {
                            ...
                            if (e.keyCode == 27) {
                                if (ezoom.isShow) {
                                    if (ezoom.scale != 1 || ezoom.rotate != 0 || ezoom.translateX != 0 || ezoom
                                        .translateY != 0) {
                                        ezoom.reset();
                                    } else {
                                        ezoom.remove();
