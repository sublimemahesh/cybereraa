         ...
         <div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
            <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                 <ul>
                     ...
                     <!-- MAIN IMAGE -->
                     <img src="{{asset('assets/frontend/images/main-slider/slider2/slide1.jpg') }}"  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina/>
                     <!-- LAYERS -->
                     ...
                     style="z-index: 13;">
                     <img src="{{asset('assets/frontend/images/main-slider/slider2/earth2.png') }}" alt="" class="spin-city">
                     </div>
                     ...
                     style="z-index: 13;">
                     <img src="{{asset('assets/frontend/images/main-slider/slider2/plant.png') }}" alt="">
                     </div>
                   </li>
