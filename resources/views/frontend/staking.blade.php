<x-frontend.layouts.app>
    @section('title', 'Staking Package | coin1m | One to One Marketing Website')
    ...
    @section('meta')
        ...
        <meta name="keywords"
            content="Coin1m, Coin1m, one to one marketing, one to one marketing website, network marketing website, e money sites, money investment sites, cryptocurrency trading, trade, trade online, trades websites">
