<x-frontend.layouts.app>
    @section('title', 'About Us | Cybereraa')
			...
			<div class="col-lg-12">
				<div class="breacumb-content">
					...
					<div class="breadcumb-content-text">
						<a href="index-2.html"><span>home</span> About us</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="sections-title">
					...
					<div class="main-title">
						<h1>Crypto Best Features</h1>
					</div>
					<div class="section-text">
						<p>Cryptocurrencies are used primarily outside existing banking and coin governmental institutions and are exchanged</p>
					</div>
				</div>
			</div>
		</div>
		<div class="row bottom">
			<div class="col-lg-4 col-md-6">
				<div class="single-feature-box">
					<div class="feature-thumb">
						<img src="{{asset('assets/frontend/images/About_5.png') }}" alt="">
					</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-feature-box">
					<div class="feature-thumb">
						<img src="{{asset('assets/frontend/images/About_6.png') }}" alt="">
					</div>
					<div class="feature-title">
			...
			<div class="col-lg-6 col-md-6">
				<div class="single-about-box">
					<div class="section-title">
						...
						<div class="main-title">
							<h1>Cryptobit Expertise</h1>
						</div>
						<div class="section-text">
							<p>Progressively predominate performance based internal or "orga sources before high standards in architectures. Interactively ini transparent functionalities via efficient ROI. Quickly administrate extensive partnerships.</p>
...
<!-- Start counter-area -->
<!--==================================================-->
<div class="counter-area" style="background: url('{{ asset('assets/frontend/images/About_1.png') }}');background-size: cover;background-position: center;background-repeat: no-repeat;">
	<div class="container">
		<div class="row">
				...
				<div class="single-counter-box">
					<div class="counter-content">
						<div class="counter-title">
							<h1><span>$</span><span class="aa">38.98</span><span>M+</span></h1>
			...
			<div class="col-lg-3 col-md-6">
				<div class="single-counter-box">
					<div class="counter-content">
						<div class="counter-title">
							<h1><span class="aa">680</span><span>K+</span></h1>
							<h5>Happy Active Users</h5>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="single-counter-box">
					<div class="counter-content">
						<div class="counter-title">
							<h1><span>$</span><span class="aa">380</span><span>M+</span></h1>
							<h5>Transections Done</h5>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="single-counter-box">
					<div class="counter-content">
						<div class="counter-title">
							<h1><span class="aa">150</span><span>K+</span></h1>
							<h5>Community BTC</h5>
						</div>
					</div>
				</div>
			...
			<div class="owl-carousel blog_list">
				...
				<div class="blog-single-box">
					<div class="blog-thumb">
						<img src="{{asset('assets/frontend/images/About_4.png') }}" alt="">
						<div class="blog-content">
						<div class="blog-left">
							<span>Mar 19, 2022</span>
						</div>
						<h2><a href="blog-details.html">Content strategy can help engage customers</a></h2>
			...
			<div class="col-lg-12">
				<div class="blog-single-box">
					<div class="blog-thumb">
						...
						<h2><a href="blog-details.html">Crypto Buy and Sell Coin with Trusted Agency.</a></h2>
						<p>Collaboratively syndicate turnkey are Energistically enable standards in the pontificate interman.</p>
					</div>
					</div>
				</div>
			...
			<div class="col-lg-12">
				<div class="blog-single-box">
					<div class="blog-thumb">
						...
						<h2><a href="blog-details.html">Coin strategy can help you engage Audience</a></h2>
						<p>Collaboratively syndicate turnkey are Energistically enable standards in the pontificate interman.</p>
					</div>
					</div>
				</div>
