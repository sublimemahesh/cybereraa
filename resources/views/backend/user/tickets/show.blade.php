<x-backend.layouts.app>
    ...
    @section('breadcrumb-items')
        <li class="breadcrumb-item">
            <a href="{{ route('user.support.tickets.index') }}">Support Tickets</a>
        </li>
            ...
            <div class="card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a class="btn-dark btn-xs btn-rounded my-2 text-white" href="{{ route('user.support.tickets.index') }}"> Back to list</a>
