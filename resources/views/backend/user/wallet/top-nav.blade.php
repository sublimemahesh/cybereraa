    ...
    <div class="card">
        <nav>
            <div class="order nav nav-tabs">
                ...
                <a class="nav-link {{ request()->routeIs('user.wallet.withdraw') ? 'active' : '' }}" href="{{ !request()->routeIs('user.wallet.withdraw') ? route('user.wallet.withdraw') : 'javascript:void(0)' }}">Binance Funds</a>
