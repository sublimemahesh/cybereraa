        ...
        <div class="card-header border-0  flex-wrap">
            <nav>
                <div class="order nav nav-tabs">
                    ...
                    @endcan
                    <a class="nav-link {{ request()->routeIs('user.ranks.team-rankers') ? 'active' : '' }}" href="{{ !request()->routeIs('user.ranks.team-rankers') ? route('user.ranks.team-rankers') : 'javascript:void(0)' }}">Team Rankers</a>
