...
{{--        <a class="nav-link {{ request()->routeIs('user.ranks.summery') ? 'active' : '' }}" href="{{ !request()->routeIs('user.ranks.summery') ? route('user.ranks.summery') : 'javascript:void(0)' }}">My Ranks & Eligibility</a>--}}
        ...
        @endcan--}}
        <a class="nav-link {{ request()->routeIs('user.special-bonus') ? 'active' : '' }}" href="{{ !request()->routeIs('user.special-bonus') ? route('user.special-bonus') : 'javascript:void(0)' }}">Special Bonus Requirement</a>
