<x-backend.layouts.app>
    @section('title', 'Wallet Transaction | Reports')
    @section('header-title', 'Admin Wallet History | Reports' )
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div>
                                    <div class="md:flex md:flex-wrap">
                                        ...
                                        <div class="flex flex-col mb-2 md:w-1/2 lg:w-1/4">
                                            <div>
                                                <div class=" pt-2 p-2 ">
                                                    <label for="history-date-range" class="text-gray-700 dark:text-gray-300">PERIOD</label>
                                                    <div class="relative">
                                                        <form autocomplete="off">
                                                            <input id="history-date-range" class="flatpickr block my-1 bg-gray-50 text-gray-700 py-2 px-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 w-full active dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500 flatpickr-input" type="text" placeholder="Select a period" readonly="readonly">
                                                        </form>
                                                        <div class="pointer-events-none rounded absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500">
                                                            <svg class="pointer-events-none w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                        ...
                                        <div class="flex flex-col mb-2">
                                            <div>
                                                <div class=" pt-2 p-2 ">
                                                    ...
                                                    <div class="relative">
                                                        <button id="history-search" class="mt-1 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                                                            Search
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="table-responsive">
                        <table id="history" class="display mb-1 table-responsive-my" style="table-layout: fixed">
                            <thead>
                            <tr>
                                <th>TYPE</th>
                                <th>USER</th>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/backend/js/admin/admin-wallets/wallet-transaction.js') }}"></script>
    @endpush
</x-backend.layouts.app>
