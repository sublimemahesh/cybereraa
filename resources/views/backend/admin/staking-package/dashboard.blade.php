                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card card-wiget">
                                    <div class="card-body">
                                        <div class="card-wiget-info">
                                            <h4 class="count-num">${{ number_format($total_hold_staking_amount,2) }} in {{ $total_hold_staking_count }} sales</h4>
                                            <p class="sm-chart">Total HOLD Staking</p>
                                        </div>
                                ...
                                <div class="card card-wiget">
                                    <div class="card-body">
                                        <div class="card-wiget-info rewards">
                                            <h4 class="count-num">${{ number_format($total_canceled_staking_amount,2) }}</h4>
                                            <p>Total Canceled Sales </p>
                                            <div>
                                                <span class="text-primary">-${{ number_format($total_canceled_staking_amount_with_interest,2) }} Sales </span>
                                            </div>
                                            <div class="d-flex align-items-baseline reward-earn">
                                                <h2 class="me-2">{{ $total_sale_amount > 0 ? round(($total_canceled_staking_amount/ $total_sale_amount) *100) : 0 }}%</h2>
                                                {{-- <span>Level 2</span>--}}
                                            </div>
                                            <div class="progress-box">
                                                <div class="progress">
                                                    <div class="progress-bar bg-primary" style="width:{{ $total_sale_amount > 0 ? round(($total_canceled_staking_amount/ $total_sale_amount) *100) : 0 }}%; height:7px; border-radius:4px;" role="progressbar"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-4">
                            <div class="media">
                                ...
                                <div class="media-body text-white">
                                    ...
                                    <br>
                                    <small>Total Fee: $ {{$total_withdraws_transaction_fees}} </small>
                                </div>
                            </div>
                        </div>
                    </div>
