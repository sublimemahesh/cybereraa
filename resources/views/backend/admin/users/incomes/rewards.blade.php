<x-backend.layouts.app>
    @section('title', 'Reward Incomes | Reports')
    @section('header-title', 'Reward Incomes | Reports' )
    ...
    @section('breadcrumb-items')
        <li class="breadcrumb-item">Bonus Rewards</li>
    @endsection
    ...
    @push('scripts')
        <script>
            const INCOMES_URL = location.href;
