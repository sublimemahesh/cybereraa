                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card card-wiget">
                                    ...
                                    <div class="back-icon">
                                        <svg width="138" height="113" viewBox="0 0 138 113" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.05">
                                                <path
                    ...
                    <div class="widget-stat card">
                        <div class="card-body p-4">
                            <div class="media ai-icon">
                                ...
                                <div class="media-body">
                                    <p class="mb-1">Today Traffic</p>
                                    <h4 class="mb-0">6850</h4>
                                    <span class="badge badge-success">-3.5%</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('assets/backend/images/avatar/1.jpg') }}">
                                            </div>
                                            <div class="media-body">
                                ...
                                <ul class="timeline">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1">Jacob Tucker <small class="">29 July
                                                        2020</small></h5>
                                                <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" class="btn btn-danger btn-xxs">Delete</a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2 media-success">
                                                <img alt="image" width="50" src="{{ asset('assets/backend/images/avatar/2.jpg') }}">
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-1">Jack Ronan <small class="">29 July
                                                        2020</small></h5>
                                                <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" class="btn btn-danger btn-xxs">Delete</a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1">Noah Baldon <small class="">29 July
                                                        2020</small></h5>
                                                <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" class="btn btn-danger btn-xxs">Delete</a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1">Thomas Grady <small class="">02:26 PM</small>
                                                </h5>
                                                <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" class="btn btn-danger btn-xxs">Delete</a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2 media-primary">
                                                <img alt="image" width="50" src="{{ asset('assets/backend/images/avatar/3.jpg') }}">
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-1">Oscar Weston <small class="">29 July
                                                        2020</small></h5>
                                                <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" class="btn btn-danger btn-xxs">Delete</a>
