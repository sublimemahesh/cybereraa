                    ...
                    <tr>
                        <td>
                            <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                                ...
                                <tr>
                                    <td>
                                        <img src="https://www.coin1m.com/assets/frontend/images/logo-light.png" alt="{{ config('app.name','Coin1m') }}" style="height: 50px;">
                                    </td>
                                    <td style="text-align: right; color:#999">
                                        <span>{{ config('app.name','Coin1m') }}</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        <p style="font-size:13px; margin:0;">
                                            ©Copyright {{ date('Y') }} {{ config('app.name','Coin1m') }} All Rights Reserved
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
