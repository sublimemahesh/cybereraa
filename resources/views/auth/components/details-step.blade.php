...
<div class="col-lg-6 mb-4">
    <label class="mb-1" for="first_name"><strong>{{ __('First Name') }}<sup class="main-required">*</sup></strong></label>
...
<div class="col-lg-6 mt-4">
    <div>
        <label class="mb-1" for="phone"><strong>{{ __('Mobile Number') }}<sup class="main-required">*</sup></strong></label>
...
<div class="col-lg-6 mt-4">
    <label class="mb-1" for="password_confirmation"><strong>{{ __('Confirm Password') }}<sup class="main-required">*</sup></strong></label>
