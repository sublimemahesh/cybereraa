<div class="col-lg-6  mt-4">
    <label class="mb-1" for="nic" ><strong class="main-registerFormText">{{ __('NIC') }}<sup class="main-required">*</sup></strong></label>
...
<div class="col-lg-6  mt-4">
    <label class="mb-1" for="driving_lc_number" ><strong class="main-registerFormText">{{ __('Driving license number') }}<sup class="main-required">*</sup></strong></label>
...
<div class="col-lg-6  mt-4">
    <label class="mb-1" for="passport_number" ><strong class="main-registerFormText">{{ __('Passport number') }}<sup class="main-required">*</sup></strong></label>
